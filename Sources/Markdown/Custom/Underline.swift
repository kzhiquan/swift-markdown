...
//  swift-markdown
//
//  Created by kzhiquan on 2025/9/13.
//

/// An element that tags inline elements with strong emphasis.
public struct Underline: RecurringInlineMarkup, BasicInlineContainer {
    public var _data: _MarkupData
    init(_ raw: RawMarkup) throws {
        guard case .underline = raw.data else {
...
public extension Underline {
    ...
    init(_ newChildren: some Sequence<InlineMarkup>, inheritSourceRange: Bool) {
        ...
        try! self.init(.underline(parsedRange: parsedRange, rawChildren))
    }
    ...
    func accept<V: MarkupVisitor>(_ visitor: inout V) -> V.Result {
        return visitor.visitUnderline(self)
    }
}
...
public extension MarkupVisitor {
    ...
    mutating func visitUnderline(_ underline: Underline) -> Result {
